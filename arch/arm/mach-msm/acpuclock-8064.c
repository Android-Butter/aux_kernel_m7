...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[3]  = { {  324000, PLL_8, 0, 0x04 },  950000, 1050000, 1 },
	[4]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[5]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[6]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[7]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
	[8]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1050000, 2 },
	[9]  = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1050000, 4 },
	[10]  = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1150000, 4 },
	[11]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 },
	[12]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 },
	[13] = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 },
	[14] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 5 },
	[15] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1150000, 5 },
	[16] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 5 },
	[17] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 5 },
	[18] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 5 },
	[19] = { { 1188000, HFPLL, 1, 0x2C }, 1175000, 1175000, 5 },
	[20] = { { 1242000, HFPLL, 1, 0x2E }, 1175000, 1175000, 6 },
	[21] = { { 1296000, HFPLL, 1, 0x30 }, 1175000, 1175000, 6 },
	{ }
};	
#else
static struct l2_level l2_freq_tbl[] __initdata = {
...
static struct acpu_level tbl_AUX[] __initdata = {
	{ 1, {    48000, PLL_8, 0, 0x00 }, L2(0),   800000 },
	{ 1, {    96000, PLL_8, 0, 0x00 }, L2(1),   800000 },
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(2),   825000 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(4),   825000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(4),   850000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(8),   850000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(8),   850000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(8),   850000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(8),   875000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   875000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(8),   900000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16),  925000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16),  937500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(16),  962500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1000000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(18), 1025000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(18), 1050000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(20), 1100000 },
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(20), 1112500 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(20), 1137500 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(20), 1175000 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(20), 1225000 },
	{ 1, {  1988000, HFPLL, 1, 0x4A }, L2(21), 1275000 },
	{ 1, {  2052000, HFPLL, 1, 0x4C }, L2(21), 1312500 },
	{ 1, {  2106000, HFPLL, 1, 0x4E }, L2(21), 1350000 },
	{ 0, { 0 } }
};
#endif
...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	...
	{ 1, {   135000, HFPLL, 1, 0x05 }, L2(0),   875000 },
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
	{ 1, {    81000, HFPLL, 1, 0x03 }, L2(0),   775000 },
	{ 1, {   135000, HFPLL, 1, 0x05 }, L2(0),   800000 },
	{ 1, {   243000, HFPLL, 2, 0x12 }, L2(0),   825000 },
